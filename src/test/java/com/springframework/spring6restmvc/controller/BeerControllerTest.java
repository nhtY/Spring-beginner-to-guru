...
//    BeerController beerController;
    ...
    void testCreateBeerWithNullBeerName() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null, null, 1, 25).get(1));
    ...
    void patchBeerById() throws Exception {
        BeerDTO testBeer = beerServiceImpl.listBeers(null, null, null, 1, 25).get(0);
